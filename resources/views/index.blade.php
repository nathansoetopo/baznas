                            ...
                            @foreach ($highlight as $h)
                                <div class="mt-3 col-sm-6 col-lg-4 col-md-4">
                                    <div class="card" style="border-radius: 15px;">
                                        <img src="{{ asset($h->gambar) }}" class="card-img-top" alt=""
                                            style="background-color: #FF9900; border-top-left-radius: 15px; border-top-right-radius: 15px;
                                    height: 37vh;">
                                        <div class="card-body"
                                            style="background-color: #FF9900; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px; height: 20vh;">
                                            <a href="{{ url('kabar-detail/' . $h->id) }}"
                                                style="color: #2E3192; opacity: 0.7;">
                                                <h5 class="font-highlight">{{ $h->judul }}</h5>
                                            </a>
                                            <div class="card-text carrousel-preview">
                                                {!! \Illuminate\Support\Str::words($h->deskripsi, 10, $end = '...') !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mt-5">
                                <div class="card" id="showform">
                                    <div class="card-body" style="background-color: #01502D;">
                                        <h5 class="card-title" style="color:white; text-align: left;"><b>Komponen
                                                Zakat</b>
                                        </h5>
                                        <div>&nbsp;</div>
                                        ...
                                        <p class="card-text" style="color: white; text-align: left;">Pendapatan lain
                                            bulanan
                                            (optional)</p>
                                        <div class="col-auto">
                                            <div class="input-group">
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5">
                    ...
                    <div class="col-md-6 pb-3">
                        ...
                        <div>&nbsp;</div>
                        <iframe id='youtube' src="https://www.youtube.com/embed/RGZ9fCX7uU8"
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group mt-2">
                            ...
                            <span class="input-group-text" style="background-color: #E5E5E5; color: black;">Rp.
                                {{ $fidyah + $sedekah + $infaq + $fitrah }}</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <div id="carouselExampleControls" class="carousel slide p-0" data-bs-ride="carousel">
                            <div class="carousel-inner" id="result-carrousel">
                                <div class="carousel-item active">
                                    <!--Card-->
                                    <div class="row" style="margin-left: 9%; margin-right: 9%;">
                                        @foreach ($data as $k)
                                            @if ($k->category->name == 'zakat')
                                    ...
                                    <button class="carousel-control-prev" type="button"
                                        id="prev" data-bs-slide="prev" data-id="{{$min}}">
                                        <span class="carousel-control-prev-icon bg-dark" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next" type="button"
                                        id="next" data-bs-slide="next" data-id="{{$min}}">
                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-md-12">
                        ...
                        background-color: #2E3192; left:0;right:0;margin-left: auto;margin-right: auto; transform: translateY(-50%);">
                            ...
                            <div class="card-body" style="border: none; background-color: transparent;">
                                <p class="text-dark"
                                    style="font-size:18px; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
